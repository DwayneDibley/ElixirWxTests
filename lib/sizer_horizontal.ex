defmodule HorizontalSizer do
  ...
  """
  def run() do
    Logger.info("Horizontal sizer Test Starting")

    HorizontalSizerWindow.createWindow(show: true)

    # We break out of the loop when the exit button is pressed.
    Logger.info("Horizontal Sizer Test Exiting")
    {:ok, self()}
  end
